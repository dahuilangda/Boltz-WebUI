...
for path in (ROOT_DIR, CAPABILITIES_DIR):
    path_text = str(path)
    if path_text not in sys.path:
        sys.path.insert(0, path_text)

from backend.routes import mmp_lifecycle as routes
...
def main() -> int:
    ...
    parser.add_argument(
        "--state",
        default="capabilities/lead_optimization/data/mmp_lifecycle_admin/state.json",
    ...
    parser.add_argument(
        ...
        default="capabilities/lead_optimization/data/mmp_lifecycle_admin/uploads/batch_20260222_121849_1aa49b58/compounds.tsv",
